...
class RobotContainer {
    ...
    private val driverController = CommandXboxController(Constants.Controllers.kDriverControllerPort)
    private val lStickBtn = driverController.leftStick()
    private val startBtn = driverController.start()

    private final val autoCommandNames = arrayListOf("PastLine", "Balance", "BalancePastLine")
    private final val autoCommands = arrayListOf( Autos.pastLine(driveSubsystem)
    ...
    private fun configureBindings() {
        driveSubsystem.setDefaultCommand(driveSubsystem.drive( driverController.getLeftY()
                                                             , driverController.getRightX()))
        // driveSubsystem.setDefaultCommand(Commands.run({driveSubsystem.drive( driverController.getLeftY()
        //                                                                    , driverController.getRightX()}))
